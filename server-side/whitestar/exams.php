...
function standardizeDate($strDate)
{
	...
	$REFERENCEMONTH = 1; // 9 FOR 1ST SEMESTER, 1 FOR 2ND SEMESTER AND 5 FOR 3RD SEMESTER
	$REFERENCEYEAR = 2016; // START OF THE SEMESTER
...
if(isset($_GET["mssv"])){
	...
	$semester="20152"; //Semester code for remote querying
