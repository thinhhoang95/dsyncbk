...
public class WelcomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set the texts, the pictures from the parameters
        ImageView mPicture = (ImageView) v.findViewById(R.id.picture);
        TextView mTitleTextView=(TextView) v.findViewById(R.id.TitleTextView);
        TextView mDescriptionTextView=(TextView) v.findViewById(R.id.DescriptionTextView);
        mTitleTextView.setText(mTitle);
        mDescriptionTextView.setText(mDescription);
        mPicture.setImageResource(mImage);
        return v;
    }
